...
- 🤖 Actively applying **Machine Learning** in FinTech, building algorithmic trading systems (CryptoVolt) and fraud detection lakehouses.  
- 🌱 Currently preparing for international Master's programs in Computer Science and Data Science.  

## 🔹 Technical Skills  
- **Programming Languages:** Python, Java, C++, SQL  
- **Data Engineering & Big Data:** PySpark, Apache Spark, Airflow, Pandas, NumPy  
- **Cloud & Data Platforms:** Azure Data Factory, Databricks, Snowflake, Google BigQuery, Google Cloud Storage (GCS)  
